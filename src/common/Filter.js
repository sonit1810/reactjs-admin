    ...
    render() {
        ...
        return (
            ...
            >
                    ...
                    <form className="form-horizontal">
                        <div className="form-group row">
                            ...
                            <div className="col-md-9">
                                <input type="text" className="form-control " id="user" name="username" placeholder="Enter any chars to search" />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label htmlFor="user_group" className="col-sm-3 control-label">Type</label>
                            <div className="col-sm-9">
                                <select className="form-control" id="user_group" name="user_group">
                ...
                <Modal.Footer>
                    <button onClick={this._refreshPage} type="button" className="btn btn-secondary">
